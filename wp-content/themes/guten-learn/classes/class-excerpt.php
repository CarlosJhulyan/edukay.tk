...
* Suit Mag: Excerpt
*
* @since Guten Learn 1.0.0
*/
if( ! class_exists( 'Guten_Learn_Excerpt' ) ):

class Guten_Learn_Excerpt{
...
/**
* Call to Guten_Learn_Excerpt
*
* @since  1.0.0
* @uses   Guten_Learn_Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'guten_learn_excerpt' ) ):

    function guten_learn_excerpt( $length = 55, $echo = true, $more = '', $page_id = false ) {
        $length = apply_filters( 'suit_mag_custom_excerpt_length', $length );
        return Guten_Learn_Excerpt::get_instance()->excerpt( $length, $echo, $more, $page_id );
    }
endif;