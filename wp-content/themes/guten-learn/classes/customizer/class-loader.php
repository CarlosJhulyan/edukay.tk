...
class Guten_Learn_Customizer_Loader extends Guten_Learn_Helper{
	...
	public static function script(){
		...
		wp_localize_script( self::with_prefix( 'customize-js' ), 'gutenLearnColorPalette',
			array( 
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
...
new Guten_Learn_Customizer_Loader();
