...
class Guten_Learn_Customizer_Dimensions_Control extends WP_Customize_Control {
	 ...
	 * @package Guten Learn WordPress Theme
	 */
	public $type = 'guten-learn-dimensions';
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'guten-learn' );
	...
	protected function content_template() {
		...
		<ul class="desktop control-wrap active">
	        ...
	        <li class="dimension-wrap">
	            <div class="link-guten-learn-dimensions">
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'guten-learn' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'guten-learn' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'guten-learn' ),
			'desktop_left' 		=> esc_html__( 'Left', 'guten-learn' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'guten-learn' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'guten-learn' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'guten-learn' ),
			'tablet_left' 		=> esc_html__( 'Left', 'guten-learn' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'guten-learn' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'guten-learn' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'guten-learn' ),
			'mobile_left' 		=> esc_html__( 'Left', 'guten-learn' 	),
		);
		if ( false === $id ) {
