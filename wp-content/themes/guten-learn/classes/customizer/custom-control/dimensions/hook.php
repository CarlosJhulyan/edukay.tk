...
if( !class_exists( 'Guten_Learn_Customizer_Dimensions_Integration' ) ){

	class Guten_Learn_Customizer_Dimensions_Integration extends Guten_Learn_Customizer{
		...
		public static $type = 'guten-learn-dimensions';

		public static $class = 'Guten_Learn_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'guten-learn' );
	...
	new Guten_Learn_Customizer_Dimensions_Integration();
}
