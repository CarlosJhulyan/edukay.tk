<?php
/**
 * Customizer Control: guten-learn-buttonset.
 *
 * @since   1.0.0
 *
...
if ( class_exists( 'WP_Customize_Control' ) ){
	class Guten_Learn_Customizer_Buttonset_Control extends WP_Customize_Control {
		 ...
		 * @package Guten Learn WordPress Theme
		 */
		public $type = 'guten-learn-buttonset';
		...
		protected function content_template() {
			...
			<# } #>
			<div id="input_{{ data.id }}" class="guten-learn-buttonset">
...
Guten_Learn_Customizer::add_custom_control( array(
    ...
    'class'    => 'Guten_Learn_Customizer_Buttonset_Control',
