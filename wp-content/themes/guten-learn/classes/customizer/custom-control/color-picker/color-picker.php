...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Guten_Learn_Customizer_Color_Control extends WP_Customize_Control {

		public $type = 'guten-learn-color-picker';
...
Guten_learn_Customizer::add_custom_control( array(
    ...
    'class'    => 'Guten_Learn_Customizer_Color_Control',
    'sanitize' => array( 'Guten_Learn_Customizer', 'sanitize_rgba' ),
));