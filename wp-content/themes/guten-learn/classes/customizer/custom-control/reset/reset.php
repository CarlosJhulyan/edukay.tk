...
if ( class_exists( 'WP_Customize_Control' ) ) :
    ...
    class Guten_Learn_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts(){
            ...
            wp_localize_script( Guten_Learn_Helper::with_prefix( 'customize-js' ), 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'guten-learn' )
            ));
        }
...
Guten_Learn_Customizer::add_custom_control( array(
    ...
    'class'    => 'Guten_Learn_Customizer_Reset',
    'sanitize' => false,
