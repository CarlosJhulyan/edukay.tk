 ...
 */
if( !class_exists( 'Guten_Learn_Customizer_Slider_Integration' ) ){
	class Guten_Learn_Customizer_Slider_Integration extends Guten_Learn_Customizer{
		 ...
		 * @package Guten Learn WordPress Theme
		 */
		public static $type = 'guten-learn-slider';

		public static $class = 'Guten_Learn_Customizer_Slider_Control';
	...
	new Guten_Learn_Customizer_Slider_Integration();
}