...
<section id="primary" class="content-area">
	<main id="main" class="site-main container">
		<div class="error-404 not-found">
			<h1><?php echo esc_html__( 'Oops!', 'guten-learn' ) ?></h1>
			<p><?php echo esc_html__( 'This page doesn\'t seem to exist.', 'guten-learn' ) ?></p>
			...
			<div>
				<p><?php esc_html_e( 'It looks like the link pointing here was faulty. Maybe try searching?', 'guten-learn' ) ?></p>
				<?php get_search_form(); ?>
				<a href="<?php echo esc_url( home_url( '/' ) ) ?>" 
					class="<?php echo esc_attr( Guten_Learn_Helper::with_prefix( 'btn-primary' ) ); ?>">
					<?php echo esc_html__( 'Goto Homepage', 'guten-learn' ) ?>
