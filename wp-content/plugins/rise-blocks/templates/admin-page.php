        ...
        <div class="rb-col-6">
            <div class="rb-intro-head">
                ...
                <div class="rb-btn-wrap with-icon">
                    <a href="https://riseblocks.com/block-demos" target="_blank" class="rb-icon-arrow">Get templates</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="rb-col-3">
                            <div class="rb-inner-padding">
                                <div class="rb-available-icon-box-wrap rb-text-center">
                                    <div class="rb-icon-image"><?php echo $content[ 'icon' ]; ?></div>
                                    <h2><?php echo $content[ 'title' ]; ?></h2>
                                    <p class="rb-description rb-icon-description"><?php echo $content[ 'description' ]; ?></p>
                                    <a target="_target" href="https://riseblocks.com/blocks">
                                        Explore more...
                                    </a>
                                </div>
                            </div>
