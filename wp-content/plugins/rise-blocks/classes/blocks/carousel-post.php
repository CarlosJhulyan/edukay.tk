		...
		*/
		public function render( $attrs, $content ){
			...
			if( $query->have_posts() ):
				...
				?>
				<section id="<?php echo esc_attr( $attrs[ 'block_id' ] ); ?>" class="<?php echo $section_cls; ?>">
					<div class="<?php self::add_prefix_e( '%prefix-carousel-post-overlay' ); ?>"></div>
					<h2 class="<?php self::add_prefix_e( '%prefix-news-2-title' ); ?>"><?php echo $attrs['title']; ?></h2>
				    ...
				    ?>
			            <div class="<?php self::add_prefix_e( '%prefix-news-2-card-wrapper' );  ?>">
			            	...
			            	<div>
			            	    <div style="background-image: url(<?php echo $src; ?>)" class="<?php self::add_prefix_e( '%prefix-news-2-card-image' ); ?>">                                                
			            	    </div>
			            	</div>
